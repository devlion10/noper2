...
public class HisNoperFix {
    ...
    @Builder
    public HisNoperFix(String crdate, BigDecimal gmilno, BigDecimal gmbalno, String gmskk, String gmdjgb, BigDecimal gmseqco, String gbsgil, String gbscotent, String wbgb, String chcontent, String jgong, String hhgname, String hhname, String sinda, String snida1, String jungon, String jungon1, String bigo, String issueorgkey, String registId, Date registTs, String updateId, Date updateTs) {
        this.crdate = crdate;
        this.gmilno = gmilno;
