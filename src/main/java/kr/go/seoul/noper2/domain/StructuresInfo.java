...
public class StructuresInfo {
    ...
    @Builder
    public StructuresInfo(BigDecimal stSeq, BigDecimal admSeq, String stDongNo, String stDongJydCd, String stJydName, String stCd, String stName, BigDecimal stArea, BigDecimal stHeight, String stPermitDate, String stPermitNo, String stCompDate, String registId, Date registTs, String updateId, Date updateTs) {
        this.stSeq = stSeq;
        this.admSeq = admSeq;
