...
@Data
@NoArgsConstructor
public class DemolitionDTO extends UserDTO {
    // U01D01F1VO
    // 순번
    private int rn;
    // 철거 구분
    ...
    // 소유자 변경 접수일자(YYYY-MM-DD)
    private String sujiljaV;
    // 소유자 변경 처리일자
    private String crilja;
    // 소유자 변경 처리일자(YYYY-MM-DD)
    private String criljaV;
    // 소유자 변경 사유
    private String bksu;
    // 소유자 카운트
    private int cntgmj;
    ...
    // 세입자 보상금 지급일자(YYYY-MM-DD)
    private String sebsiljaV;
    // 세입자 주거대책비(보상금)
    ...
    // 세입자 입주권 지급일자(YYYY-MM-DD)
    private String sejaptiljaV;
    ...
    // 도로명주소(건물)
    private String buildingNewAddr1;
    // 법정동주소(건물)
    private String buildingNewAddr2;
    // 도로명주소(건물주)
    private String gmjNewAddr1;
    // 법정동주소(건물주)
    private String gmjNewAddr2;
